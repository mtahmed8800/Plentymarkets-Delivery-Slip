...
{
    public function store(Request $request, MockApiService $mockApiService)
    {
        ...
        if (config('services.mock_api.label_generation')) {
            $response = $mockApiService->sendJsonRequest('/label', $data);
            $shipmentId = $response['shipment_id'];
            $trackingCode = $response['tracking_code'];

            // TODO: Download PDF file and add to delivery slip
        } else {
            $response = $mockApiService->sendJsonRequest('/shipment', $data);
            $shipmentId = $response['shipment_id'];
            $trackingCode = $response['tracking_code'];
        }
